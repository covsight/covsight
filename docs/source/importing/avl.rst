...
exports functional coverage as JSON. covsight automatically detects which of the
...
.. code-block:: bash
    ...
    covsight merge --input-format avl-json \
        run1.json run2.json run3.json -o merged.ncdb
