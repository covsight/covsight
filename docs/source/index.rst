...
covsight is a Python toolkit for **importing, merging, analyzing, and reporting
...
format. It works with coverage from Verilator, cocotb-coverage, AVL, and UCIS XML
files, and provides a command-line interface, HTML reports, and CI/CD format export.
