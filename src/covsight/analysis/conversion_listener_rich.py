...
Usage::
    ...
    from covsight.core.conversion.conversion_listener_rich import RichConversionListener
...
from covsight.core.conversion.conversion_listener import ConversionListener
