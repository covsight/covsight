...
class ShowCodeCoverage(ShowBase):
    ...
    def _write_lcov(self, fp):
        """Write LCOV format."""
        raise NotImplementedError("LCOV output is not yet ported to covsight")
    
    def _write_cobertura(self, fp):
        """Write Cobertura XML format."""
        raise NotImplementedError("Cobertura output is not yet ported to covsight")
    
    def _write_jacoco(self, fp):
        """Write JaCoCo XML format."""
        raise NotImplementedError("JaCoCo output is not yet ported to covsight")
    
    def _write_clover(self, fp):
        """Write Clover XML format."""
        raise NotImplementedError("Clover output is not yet ported to covsight")
